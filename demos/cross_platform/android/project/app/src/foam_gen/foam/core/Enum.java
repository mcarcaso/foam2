...
/**
* A Property type for storing enum values. 
*/
public class Enum extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  public String getJavaInfoType() {
    ...
    if ( ! javaInfoType_isSet_ ) {
      return "foam.core.AbstractEnumPropertyInfo";
    }
    return javaInfoType_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_INFO_TYPE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.core.AbstractEnumPropertyInfo")
  ...
  public String getSwiftToJSON() {
    ...
    if ( ! swiftToJSON_isSet_ ) {
      return "outputter?.output(out, (value as? foam_core_AbstractEnum)?.ordinal ?? nil)";
    }
    return swiftToJSON_;
  }
  ...
  private static foam.core.StringProperty init_SWIFT_TO_JSON() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("outputter?.output(out, (value as? foam_core_AbstractEnum)?.ordinal ?? nil)")
      .setName("swiftToJSON")
      .setForClass_("foam.core.Property")
      .build();
  }
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.Enum")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.core.Enum.OF, foam.core.Enum.TABLE_CELL_VIEW, foam.core.Method.MethodBuilder(null) // TODO give context
      .setName("getDeps")
      .setCode(null)
      .setForClass_("foam.core.Enum")
  ...
  public static Builder EnumBuilder(foam.cross_platform.Context x) {
