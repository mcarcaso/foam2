...
//  { name: "foam/u2/AttrSlot", flags: ['web'] },
  ...
  { name: "foam/nanos/http/DefaultHttpParameters", notFlags: ['build'] },
  ...
  { name: "foam/dao/StreamingClientDAO", notFlags: ['build'] },
  ...
  { name: "foam/u2/view/FileView", flags: ['web'], notFlags: ['build'] },
  ...
  { name: "foam/u2/FoamTagLoader", flags: ['web'], notFlags: ['build'] },
  ...
  { name: "foam/dao/pg/ConnectionPool", notFlags: ['build'] },
