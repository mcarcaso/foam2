...
/**
* Describes properties of type Long. 
*/
public class LongProperty extends foam.core.IntProperty implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  protected Object sqlType_;

  private boolean sqlType_isSet_ =
    false;

  private foam.core.Slot sqlType_$;

  public static foam.core.Property SQL_TYPE =
    init_SQL_TYPE();
  ...
  protected Object units_;

  private boolean units_isSet_ =
    false;

  private foam.core.Slot units_$;

  public static foam.core.Property UNITS =
    init_UNITS();
  ...
  protected Object min_;

  private boolean min_isSet_ =
    false;

  private foam.core.Slot min_$;

  public static foam.core.Property MIN =
    init_MIN();

  protected Object max_;

  private boolean max_isSet_ =
    false;

  private foam.core.Slot max_$;

  public static foam.core.Property MAX =
    init_MAX();
  ...
  protected boolean autoValidate_;

  private boolean autoValidate_isSet_ =
    false;

  private foam.core.Slot autoValidate_$;

  public static foam.core.BooleanProperty AUTO_VALIDATE =
    init_AUTO_VALIDATE();
  ...
  protected Object displayWidth_;

  private boolean displayWidth_isSet_ =
    false;

  private foam.core.Slot displayWidth_$;

  public static foam.core.Property DISPLAY_WIDTH =
    init_DISPLAY_WIDTH();
  ...
  public String getJavaInfoType() {
    ...
    if ( ! javaInfoType_isSet_ ) {
      return "foam.core.AbstractLongPropertyInfo";
    }
    return javaInfoType_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_INFO_TYPE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.core.AbstractLongPropertyInfo")
  ...
  private static foam.core.StringProperty init_JAVA_JSONPARSER() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("new foam.lib.json.LongParser()")
  ...
  public foam.core.Slot getSqlType$() {

    if ( sqlType_$ == null ) {
      sqlType_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(SQL_TYPE)
        .build();
    }
  ...
  private Object sqlType_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (Object) newValue;
  }

  public void setSqlType(Object value) {

    boolean hasOldValue = hasPropertySet("sqlType");
    Object oldValue = hasOldValue ?
      getSqlType() :
      null;
    Object castedValue = sqlType_adapt(oldValue, value, hasOldValue);
    
    sqlType_isSet_ = true;
    sqlType_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "sqlType", null };
    if ( hasListeners(args) ) {
      args[2] = getSqlType$();
      pub(args);
    }
  ...
  private static foam.core.Property init_SQL_TYPE() {

    return foam.core.Property.PropertyBuilder(null) // TODO give context
      .setName("sqlType")
      .setValue("BIGINT")
      .setForClass_("foam.core.IntProperty")
      .build();
  }
  ...
  public String getJavaCompare() {
    ...
    if ( ! javaCompare_isSet_ ) {
      return "return Long.compare(get_(o1), get_(o2));";
    }
    return javaCompare_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_COMPARE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("return Long.compare(get_(o1), get_(o2));")
      .setName("javaCompare")
      .setForClass_("foam.core.Property")
      .build();
  }
  ...
  public String getJavaComparePropertyToValue() {
    ...
    if ( ! javaComparePropertyToValue_isSet_ ) {
      return "return Long.compare(cast(key), cast(value));";
    }
    return javaComparePropertyToValue_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_COMPARE_PROPERTY_TO_VALUE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("return Long.compare(cast(key), cast(value));")
  ...
  public String getJavaComparePropertyToObject() {
    ...
    if ( ! javaComparePropertyToObject_isSet_ ) {
      return "return Long.compare(cast(key), get_(o));";
    }
    return javaComparePropertyToObject_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_COMPARE_PROPERTY_TO_OBJECT() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("return Long.compare(cast(key), get_(o));")
  ...
  public Object getSearchView() {
    ...
    {
    put("class", "foam.u2.search.IntegerSearchView");
    }
    }
    ;
    }
  ...
  public foam.core.Slot getUnits$() {

    if ( units_$ == null ) {
      units_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(UNITS)
        .build();
    }
  ...
  private Object units_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setUnits(Object value) {
    ...
    boolean hasOldValue = hasPropertySet("units");
    Object oldValue = hasOldValue ?
      getUnits() :
      null;
    Object castedValue = units_adapt(oldValue, value, hasOldValue);
    
    units_isSet_ = true;
    units_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "units", null };
    if ( hasListeners(args) ) {
      args[2] = getUnits$();
      pub(args);
    }
  ...
  private static foam.core.Property init_UNITS() {
  ...
  public foam.core.Slot getMin$() {

    if ( min_$ == null ) {
      min_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(MIN)
        .build();
    }
  ...
  private Object min_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setMin(Object value) {
    ...
    boolean hasOldValue = hasPropertySet("min");
    Object oldValue = hasOldValue ?
      getMin() :
      null;
    Object castedValue = min_adapt(oldValue, value, hasOldValue);
    
    min_isSet_ = true;
    min_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "min", null };
    if ( hasListeners(args) ) {
      args[2] = getMin$();
      pub(args);
    }
  ...
  private static foam.core.Property init_MIN() {
  ...
  public foam.core.Slot getMax$() {

    if ( max_$ == null ) {
      max_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(MAX)
        .build();
    }
  ...
  private Object max_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setMax(Object value) {
    ...
    boolean hasOldValue = hasPropertySet("max");
    Object oldValue = hasOldValue ?
      getMax() :
      null;
    Object castedValue = max_adapt(oldValue, value, hasOldValue);
    
    max_isSet_ = true;
    max_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "max", null };
    if ( hasListeners(args) ) {
      args[2] = getMax$();
      pub(args);
    }
  ...
  private static foam.core.Property init_MAX() {
  ...
  public foam.core.Slot getAutoValidate$() {

    if ( autoValidate_$ == null ) {
      autoValidate_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(AUTO_VALIDATE)
        .build();
    }
  ...
  public boolean getAutoValidate() {
    ...
    if ( ! autoValidate_isSet_ ) {
      return false;
    }
    return autoValidate_;
  }

  private boolean autoValidate_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (boolean) newValue;
  }

  public void setAutoValidate(Object value) {

    boolean hasOldValue = hasPropertySet("autoValidate");
    Object oldValue = hasOldValue ?
      getAutoValidate() :
      null;
    boolean castedValue = autoValidate_adapt(oldValue, value, hasOldValue);
    
    autoValidate_isSet_ = true;
    autoValidate_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "autoValidate", null };
    if ( hasListeners(args) ) {
      args[2] = getAutoValidate$();
      pub(args);
    }
  }

  private static foam.core.BooleanProperty init_AUTO_VALIDATE() {

    return foam.core.BooleanProperty.BooleanPropertyBuilder(null) // TODO give context
      .setName("autoValidate")
      .setForClass_("foam.core.IntProperty")
      .build();
  }
  ...
  public String getSwiftView() {
    ...
    if ( ! swiftView_isSet_ ) {
      return "foam.swift.ui.FOAMUITextFieldInt";
    }
    return swiftView_;
  }
  ...
  private static foam.core.StringProperty init_SWIFT_VIEW() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.swift.ui.FOAMUITextFieldInt")
      .setName("swiftView")
      .setForClass_("foam.core.Property")
      .build();
  }

  public foam.core.Slot getDisplayWidth$() {

    if ( displayWidth_$ == null ) {
      displayWidth_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(DISPLAY_WIDTH)
        .build();
    }
    return displayWidth_$;
  }

  public Object getDisplayWidth() {

    if ( ! displayWidth_isSet_ ) {
      return 10;
    }
    return displayWidth_;
  }

  private Object displayWidth_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (Object) newValue;
  }

  public void setDisplayWidth(Object value) {

    boolean hasOldValue = hasPropertySet("displayWidth");
    Object oldValue = hasOldValue ?
      getDisplayWidth() :
      null;
    Object castedValue = displayWidth_adapt(oldValue, value, hasOldValue);
    
    displayWidth_isSet_ = true;
    displayWidth_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "displayWidth", null };
    if ( hasListeners(args) ) {
      args[2] = getDisplayWidth$();
      pub(args);
    }
  }

  private static foam.core.Property init_DISPLAY_WIDTH() {

    return foam.core.Property.PropertyBuilder(null) // TODO give context
      .setName("displayWidth")
      .setValue(10)
      .setForClass_("foam.core.IntProperty")
      .build();
  }
  ...
  public void clearProperty(String name) {
    ...
    switch(name) {
      ...
      case "sqlType":
        sqlType_isSet_ = false;
        Object[] sqlTypeArgs = new Object[] { "propertyChange", "sqlType", null };
        if ( hasListeners(sqlTypeArgs) ) {
          sqlTypeArgs[2] = getSqlType$();
          pub(sqlTypeArgs);
        }
        return;
      ...
      case "units":
        units_isSet_ = false;
        Object[] unitsArgs = new Object[] { "propertyChange", "units", null };
        if ( hasListeners(unitsArgs) ) {
          unitsArgs[2] = getUnits$();
          pub(unitsArgs);
        }
        return;
      ...
      case "min":
        min_isSet_ = false;
        Object[] minArgs = new Object[] { "propertyChange", "min", null };
        if ( hasListeners(minArgs) ) {
          minArgs[2] = getMin$();
          pub(minArgs);
        }
        return;
      ...
      case "max":
        max_isSet_ = false;
        Object[] maxArgs = new Object[] { "propertyChange", "max", null };
        if ( hasListeners(maxArgs) ) {
          maxArgs[2] = getMax$();
          pub(maxArgs);
        }
        return;
      ...
      case "autoValidate":
        autoValidate_isSet_ = false;
        Object[] autoValidateArgs = new Object[] { "propertyChange", "autoValidate", null };
        if ( hasListeners(autoValidateArgs) ) {
          autoValidateArgs[2] = getAutoValidate$();
          pub(autoValidateArgs);
        }
        return;
      ...
      case "displayWidth":
        displayWidth_isSet_ = false;
        Object[] displayWidthArgs = new Object[] { "propertyChange", "displayWidth", null };
        if ( hasListeners(displayWidthArgs) ) {
          displayWidthArgs[2] = getDisplayWidth$();
          pub(displayWidthArgs);
        }
        return;
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.LongProperty")
      .setParent(foam.core.IntProperty.CLS_)
      .setAxioms(new Object[] {})
      .build();
  }

  public static Builder LongPropertyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public Builder setSqlType(Object value) {
    ...
    public Builder setUnits(Object value) {
    ...
    public Builder setMin(Object value) {
    ...
    public Builder setMax(Object value) {
    ...
    public Builder setAutoValidate(boolean value) {
    ...
    public Builder setDisplayWidth(Object value) {
    ...
    public LongProperty build() {
      ...
      LongProperty o = new LongProperty();
      ...
      if ( autoValidate_isSet_ ) {
        o.setAutoValidate(autoValidate_);
      }
      ...
      if ( displayWidth_isSet_ ) {
        o.setDisplayWidth(displayWidth_);
      }
