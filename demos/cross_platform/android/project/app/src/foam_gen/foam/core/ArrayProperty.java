...
public class ArrayProperty extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  private static foam.core.StringProperty init_JAVA_JSONPARSER() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("new foam.lib.json.ArrayParser()")
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.ArrayProperty")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.templates.TemplateAxiom.TemplateAxiomBuilder(null) // TODO give context
      ...
      .setForClass_("foam.core.ArrayProperty")
      .build()})
      .build();
  }

  public static Builder ArrayPropertyBuilder(foam.cross_platform.Context x) {
