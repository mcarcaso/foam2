...
public class Listener extends foam.core.AbstractMethod {

  private foam.core.Slot swiftPrivateAxiomName_$;

  protected boolean isFramed_;

  private foam.core.Slot isFramed_$;

  public static foam.core.BooleanProperty IS_FRAMED =
    init_IS_FRAMED();

  protected boolean isMerged_;

  private boolean isMerged_isSet_ =
    false;

  private foam.core.Slot isMerged_$;

  public static foam.core.BooleanProperty IS_MERGED =
    init_IS_MERGED();

  protected int mergeDelay_;

  private boolean mergeDelay_isSet_ =
    false;

  private foam.core.Slot mergeDelay_$;

  public static foam.core.IntProperty MERGE_DELAY =
    init_MERGE_DELAY();
  ...
  protected String swiftListenerName_;

  private boolean swiftListenerName_isSet_ =
    false;

  private foam.core.Slot swiftListenerName_$;

  public static foam.core.StringProperty SWIFT_LISTENER_NAME =
    init_SWIFT_LISTENER_NAME();

  protected String swiftListenerDispatchQueue_;

  private boolean swiftListenerDispatchQueue_isSet_ =
    false;

  private foam.core.Slot swiftListenerDispatchQueue_$;

  public static foam.core.StringProperty SWIFT_LISTENER_DISPATCH_QUEUE =
    init_SWIFT_LISTENER_DISPATCH_QUEUE();

  protected String swiftListenerMethodName_;

  private boolean swiftListenerMethodName_isSet_ =
    false;

  private foam.core.Slot swiftListenerMethodName_$;

  public static foam.core.StringProperty SWIFT_LISTENER_METHOD_NAME =
    init_SWIFT_LISTENER_METHOD_NAME();
  ...
  protected String androidListenerName_;

  private boolean androidListenerName_isSet_ =
    false;

  private foam.core.Slot androidListenerName_$;

  public static foam.core.StringProperty ANDROID_LISTENER_NAME =
    init_ANDROID_LISTENER_NAME();
  ...
  private boolean isFramed_isSet_ =
    false;
  ...
  public foam.core.Slot getIsFramed$() {

    if ( isFramed_$ == null ) {
      isFramed_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(IS_FRAMED)
        .build();
    }
  ...
  private boolean isFramed_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (boolean) newValue;
  }

  public void setIsFramed(Object value) {

    boolean hasOldValue = hasPropertySet("isFramed");
    Object oldValue = hasOldValue ?
      getIsFramed() :
      null;
    boolean castedValue = isFramed_adapt(oldValue, value, hasOldValue);
    
    isFramed_isSet_ = true;
    isFramed_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "isFramed", null };
  ...
  private static foam.core.BooleanProperty init_IS_FRAMED() {

    return foam.core.BooleanProperty.BooleanPropertyBuilder(null) // TODO give context
      .setValue(false)
      .setName("isFramed")
      .setForClass_("foam.core.Listener")
      .build();
  }

  public foam.core.Slot getIsMerged$() {

    if ( isMerged_$ == null ) {
      isMerged_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(IS_MERGED)
        .build();
    }
  ...
  private boolean isMerged_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (boolean) newValue;
  }

  public void setIsMerged(Object value) {

    boolean hasOldValue = hasPropertySet("isMerged");
    Object oldValue = hasOldValue ?
      getIsMerged() :
      null;
    boolean castedValue = isMerged_adapt(oldValue, value, hasOldValue);
    
    isMerged_isSet_ = true;
    isMerged_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "isMerged", null };
    if ( hasListeners(args) ) {
      args[2] = getIsMerged$();
      pub(args);
    }
  ...
  private static foam.core.BooleanProperty init_IS_MERGED() {
  ...
  public foam.core.Slot getMergeDelay$() {

    if ( mergeDelay_$ == null ) {
      mergeDelay_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(MERGE_DELAY)
        .build();
    }
  ...
  public int getMergeDelay() {

    if ( ! mergeDelay_isSet_ ) {
      return 16;
    }
    return mergeDelay_;
  }

  private int mergeDelay_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (int) newValue;
  }

  public void setMergeDelay(Object value) {

    boolean hasOldValue = hasPropertySet("mergeDelay");
    Object oldValue = hasOldValue ?
      getMergeDelay() :
      null;
    int castedValue = mergeDelay_adapt(oldValue, value, hasOldValue);
    
    mergeDelay_isSet_ = true;
    mergeDelay_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "mergeDelay", null };
    if ( hasListeners(args) ) {
      args[2] = getMergeDelay$();
      pub(args);
    }
  }

  private static foam.core.IntProperty init_MERGE_DELAY() {
  ...
  public foam.core.Slot getSwiftListenerName$() {

    if ( swiftListenerName_$ == null ) {
      swiftListenerName_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(SWIFT_LISTENER_NAME)
        .build();
    }
    return swiftListenerName_$;
  }

  public String getSwiftListenerName() {

    if ( ! swiftListenerName_isSet_ ) {
      return "";
    }
    return swiftListenerName_;
  }

  private String swiftListenerName_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (String) newValue;
  }

  public void setSwiftListenerName(Object value) {

    boolean hasOldValue = hasPropertySet("swiftListenerName");
    Object oldValue = hasOldValue ?
      getSwiftListenerName() :
      null;
    String castedValue = swiftListenerName_adapt(oldValue, value, hasOldValue);
    
    swiftListenerName_isSet_ = true;
    swiftListenerName_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "swiftListenerName", null };
    if ( hasListeners(args) ) {
      args[2] = getSwiftListenerName$();
      pub(args);
    }
  }

  private static foam.core.StringProperty init_SWIFT_LISTENER_NAME() {

    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setName("swiftListenerName")
      .setExpression(null)
      .setForClass_("foam.core.Listener")
      .build();
  }

  public foam.core.Slot getSwiftListenerDispatchQueue$() {

    if ( swiftListenerDispatchQueue_$ == null ) {
      swiftListenerDispatchQueue_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(SWIFT_LISTENER_DISPATCH_QUEUE)
        .build();
    }
    return swiftListenerDispatchQueue_$;
  }

  public String getSwiftListenerDispatchQueue() {

    if ( ! swiftListenerDispatchQueue_isSet_ ) {
      return "DispatchQueue.main";
    }
    return swiftListenerDispatchQueue_;
  }

  private String swiftListenerDispatchQueue_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (String) newValue;
  }

  public void setSwiftListenerDispatchQueue(Object value) {

    boolean hasOldValue = hasPropertySet("swiftListenerDispatchQueue");
    Object oldValue = hasOldValue ?
      getSwiftListenerDispatchQueue() :
      null;
    String castedValue = swiftListenerDispatchQueue_adapt(oldValue, value, hasOldValue);
    
    swiftListenerDispatchQueue_isSet_ = true;
    swiftListenerDispatchQueue_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "swiftListenerDispatchQueue", null };
    if ( hasListeners(args) ) {
      args[2] = getSwiftListenerDispatchQueue$();
      pub(args);
    }
  }

  private static foam.core.StringProperty init_SWIFT_LISTENER_DISPATCH_QUEUE() {

    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("DispatchQueue.main")
      .setName("swiftListenerDispatchQueue")
      .setForClass_("foam.core.Listener")
      .build();
  }

  public foam.core.Slot getSwiftListenerMethodName$() {

    if ( swiftListenerMethodName_$ == null ) {
      swiftListenerMethodName_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(SWIFT_LISTENER_METHOD_NAME)
        .build();
    }
    return swiftListenerMethodName_$;
  }

  public String getSwiftListenerMethodName() {

    if ( ! swiftListenerMethodName_isSet_ ) {
      return "";
    }
    return swiftListenerMethodName_;
  }

  private String swiftListenerMethodName_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (String) newValue;
  }

  public void setSwiftListenerMethodName(Object value) {

    boolean hasOldValue = hasPropertySet("swiftListenerMethodName");
    Object oldValue = hasOldValue ?
      getSwiftListenerMethodName() :
      null;
    String castedValue = swiftListenerMethodName_adapt(oldValue, value, hasOldValue);
    
    swiftListenerMethodName_isSet_ = true;
    swiftListenerMethodName_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "swiftListenerMethodName", null };
    if ( hasListeners(args) ) {
      args[2] = getSwiftListenerMethodName$();
      pub(args);
    }
  }

  private static foam.core.StringProperty init_SWIFT_LISTENER_METHOD_NAME() {

    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setName("swiftListenerMethodName")
      .setExpression(null)
      .setForClass_("foam.core.Listener")
      .build();
  }
  ...
  public void swiftInit() {

    throw new RuntimeException("swiftInit is not implemented");
  }
  ...
  public foam.core.Slot getAndroidListenerName$() {

    if ( androidListenerName_$ == null ) {
      androidListenerName_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(ANDROID_LISTENER_NAME)
        .build();
    }
    return androidListenerName_$;
  }

  public String getAndroidListenerName() {

    if ( ! androidListenerName_isSet_ ) {
      return "";
    }
    return androidListenerName_;
  }

  private String androidListenerName_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (String) newValue;
  }

  public void setAndroidListenerName(Object value) {

    boolean hasOldValue = hasPropertySet("androidListenerName");
    Object oldValue = hasOldValue ?
      getAndroidListenerName() :
      null;
    String castedValue = androidListenerName_adapt(oldValue, value, hasOldValue);
    
    androidListenerName_isSet_ = true;
    androidListenerName_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "androidListenerName", null };
    if ( hasListeners(args) ) {
      args[2] = getAndroidListenerName$();
      pub(args);
    }
  }

  private static foam.core.StringProperty init_ANDROID_LISTENER_NAME() {

    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setName("androidListenerName")
      .setExpression(null)
      .setForClass_("foam.core.Listener")
      .build();
  }
  ...
  public void clearProperty(String name) {
    ...
    switch(name) {
      ...
      case "isFramed":
        isFramed_isSet_ = false;
        Object[] isFramedArgs = new Object[] { "propertyChange", "isFramed", null };
        if ( hasListeners(isFramedArgs) ) {
          isFramedArgs[2] = getIsFramed$();
          pub(isFramedArgs);
        }
        return;
      ...
      case "isMerged":
        isMerged_isSet_ = false;
        Object[] isMergedArgs = new Object[] { "propertyChange", "isMerged", null };
        if ( hasListeners(isMergedArgs) ) {
          isMergedArgs[2] = getIsMerged$();
          pub(isMergedArgs);
        }
        return;
      ...
      case "mergeDelay":
        mergeDelay_isSet_ = false;
        Object[] mergeDelayArgs = new Object[] { "propertyChange", "mergeDelay", null };
        if ( hasListeners(mergeDelayArgs) ) {
          mergeDelayArgs[2] = getMergeDelay$();
          pub(mergeDelayArgs);
        }
        return;
      ...
      case "swiftListenerName":
        swiftListenerName_isSet_ = false;
        Object[] swiftListenerNameArgs = new Object[] { "propertyChange", "swiftListenerName", null };
        if ( hasListeners(swiftListenerNameArgs) ) {
          swiftListenerNameArgs[2] = getSwiftListenerName$();
          pub(swiftListenerNameArgs);
        }
        return;
    
    
      case "swiftListenerDispatchQueue":
        swiftListenerDispatchQueue_isSet_ = false;
        Object[] swiftListenerDispatchQueueArgs = new Object[] { "propertyChange", "swiftListenerDispatchQueue", null };
        if ( hasListeners(swiftListenerDispatchQueueArgs) ) {
          swiftListenerDispatchQueueArgs[2] = getSwiftListenerDispatchQueue$();
          pub(swiftListenerDispatchQueueArgs);
        }
        return;
    
    
      case "swiftListenerMethodName":
        swiftListenerMethodName_isSet_ = false;
        Object[] swiftListenerMethodNameArgs = new Object[] { "propertyChange", "swiftListenerMethodName", null };
        if ( hasListeners(swiftListenerMethodNameArgs) ) {
          swiftListenerMethodNameArgs[2] = getSwiftListenerMethodName$();
          pub(swiftListenerMethodNameArgs);
        }
        return;
      ...
      case "androidListenerName":
        androidListenerName_isSet_ = false;
        Object[] androidListenerNameArgs = new Object[] { "propertyChange", "androidListenerName", null };
        if ( hasListeners(androidListenerNameArgs) ) {
          androidListenerNameArgs[2] = getAndroidListenerName$();
          pub(androidListenerNameArgs);
        }
        return;
  ...
  public Object getProperty(String name) {
    ...
    switch(name) {
      ...
      case "swiftListenerName":
        return getSwiftListenerName();
    
    
      case "swiftListenerDispatchQueue":
        return getSwiftListenerDispatchQueue();
    
    
      case "swiftListenerMethodName":
        return getSwiftListenerMethodName();
  ...
  public boolean hasPropertySet(String name) {
    ...
    switch(name) {
      ...
      case "isFramed":
        return isFramed_isSet_;
    
    
      case "isMerged":
        return isMerged_isSet_;
    
    
      case "mergeDelay":
        return mergeDelay_isSet_;
      ...
      case "swiftListenerName":
        return swiftListenerName_isSet_;
    
    
      case "swiftListenerDispatchQueue":
        return swiftListenerDispatchQueue_isSet_;
    
    
      case "swiftListenerMethodName":
        return swiftListenerMethodName_isSet_;
      ...
      case "androidListenerName":
        return androidListenerName_isSet_;
  ...
  public void setProperty(String name, Object value) {
    ...
    switch(name) {
      ...
      case "isFramed":
        setIsFramed((boolean) value);
        return;
    
    
      case "isMerged":
        setIsMerged((boolean) value);
        return;
    
    
      case "mergeDelay":
        setMergeDelay((int) value);
        return;
      ...
      case "swiftListenerName":
        setSwiftListenerName((String) value);
        return;
    
    
      case "swiftListenerDispatchQueue":
        setSwiftListenerDispatchQueue((String) value);
        return;
    
    
      case "swiftListenerMethodName":
        setSwiftListenerMethodName((String) value);
        return;
      ...
      case "androidListenerName":
        setAndroidListenerName((String) value);
        return;
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.Listener")
      .setParent(foam.core.AbstractMethod.CLS_)
      .setAxioms(new Object[] {foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("Argument")
      .setPath("foam.core.Argument")
      .build(), foam.core.Listener.IS_FRAMED, foam.core.Listener.IS_MERGED, foam.core.Listener.MERGE_DELAY, foam.core.Method.MethodBuilder(null) // TODO give context
      ...
      .build(), foam.core.Listener.SWIFT_LISTENER_NAME, foam.core.Listener.SWIFT_LISTENER_DISPATCH_QUEUE, foam.core.Listener.SWIFT_LISTENER_METHOD_NAME, foam.templates.TemplateAxiom.TemplateAxiomBuilder(null) // TODO give context
      ...
      .setName("swiftInit")
      .setForClass_("foam.core.Listener")
      .build(), foam.core.Listener.ANDROID_LISTENER_NAME})
      .build();
  }

  public static Builder ListenerBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    private String swiftListenerName_;

    private boolean swiftListenerDispatchQueue_isSet_ =
      false;

    private String swiftListenerDispatchQueue_;

    private boolean swiftListenerMethodName_isSet_ =
      false;

    private String swiftListenerMethodName_;
    ...
    private String androidListenerName_;
    ...
    public Builder setIsFramed(boolean value) {
    ...
    public Builder setMergeDelay(int value) {
    ...
    public Builder setSwiftListenerName(String value) {

      swiftListenerName_isSet_ = true;
      swiftListenerName_ = value;
      return this;
    }

    public Builder setSwiftListenerDispatchQueue(String value) {

      swiftListenerDispatchQueue_isSet_ = true;
      swiftListenerDispatchQueue_ = value;
      return this;
    }

    public Builder setSwiftListenerMethodName(String value) {

      swiftListenerMethodName_isSet_ = true;
      swiftListenerMethodName_ = value;
      return this;
    }
    ...
    public Builder setAndroidListenerName(String value) {

      androidListenerName_isSet_ = true;
      androidListenerName_ = value;
      return this;
    }
    ...
    public Listener build() {
      ...
      if ( isFramed_isSet_ ) {
        o.setIsFramed(isFramed_);
      }
      
      if ( isMerged_isSet_ ) {
        o.setIsMerged(isMerged_);
      }
      
      if ( mergeDelay_isSet_ ) {
        o.setMergeDelay(mergeDelay_);
      }
      ...
      if ( swiftListenerName_isSet_ ) {
        o.setSwiftListenerName(swiftListenerName_);
      }
      
      if ( swiftListenerDispatchQueue_isSet_ ) {
        o.setSwiftListenerDispatchQueue(swiftListenerDispatchQueue_);
      }
      
      if ( swiftListenerMethodName_isSet_ ) {
        o.setSwiftListenerMethodName(swiftListenerMethodName_);
      }
      ...
      if ( androidListenerName_isSet_ ) {
        o.setAndroidListenerName(androidListenerName_);
      }
