...
/**
* StringProperties coerce their arguments into Strings. 
*/
public class StringProperty extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {

  private foam.core.Slot swiftGetter_$;

  protected boolean trim_;

  private foam.core.Slot trim_$;

  public static foam.core.BooleanProperty TRIM =
    init_TRIM();

  protected int width_;

  private boolean width_isSet_ =
    false;

  private foam.core.Slot width_$;

  public static foam.core.IntProperty WIDTH =
    init_WIDTH();
  ...
  protected Object minLength_;

  private boolean minLength_isSet_ =
    false;

  private foam.core.Slot minLength_$;

  public static foam.core.Property MIN_LENGTH =
    init_MIN_LENGTH();

  protected Object maxLength_;

  private boolean maxLength_isSet_ =
    false;

  private foam.core.Slot maxLength_$;

  public static foam.core.Property MAX_LENGTH =
    init_MAX_LENGTH();
  ...
  public static foam.core.IntProperty DISPLAY_WIDTH =
    init_DISPLAY_WIDTH();
  ...
  public foam.core.Slot getTrim$() {

    if ( trim_$ == null ) {
      trim_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(TRIM)
        .build();
    }
  ...
  private boolean trim_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (boolean) newValue;
  }

  public void setTrim(Object value) {

    boolean hasOldValue = hasPropertySet("trim");
    Object oldValue = hasOldValue ?
      getTrim() :
      null;
    boolean castedValue = trim_adapt(oldValue, value, hasOldValue);
    
    trim_isSet_ = true;
    trim_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "trim", null };
  ...
  private static foam.core.BooleanProperty init_TRIM() {

    return foam.core.BooleanProperty.BooleanPropertyBuilder(null) // TODO give context
      .setValue(false)
      .setName("trim")
      .setForClass_("foam.core.StringProperty")
      .build();
  }

  public foam.core.Slot getWidth$() {

    if ( width_$ == null ) {
      width_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(WIDTH)
        .build();
    }
  ...
  private int width_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setWidth(Object value) {
    ...
    boolean hasOldValue = hasPropertySet("width");
    Object oldValue = hasOldValue ?
      getWidth() :
      null;
    int castedValue = width_adapt(oldValue, value, hasOldValue);
    
    width_isSet_ = true;
    width_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "width", null };
    if ( hasListeners(args) ) {
      args[2] = getWidth$();
      pub(args);
    }
  ...
  private static foam.core.IntProperty init_WIDTH() {
  ...
  public foam.core.Slot getMinLength$() {

    if ( minLength_$ == null ) {
      minLength_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(MIN_LENGTH)
        .build();
    }
  ...
  private Object minLength_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setMinLength(Object value) {
    ...
    boolean hasOldValue = hasPropertySet("minLength");
    Object oldValue = hasOldValue ?
      getMinLength() :
      null;
    Object castedValue = minLength_adapt(oldValue, value, hasOldValue);
    
    minLength_isSet_ = true;
    minLength_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "minLength", null };
    if ( hasListeners(args) ) {
      args[2] = getMinLength$();
      pub(args);
    }
  ...
  private static foam.core.Property init_MIN_LENGTH() {
  ...
  public foam.core.Slot getMaxLength$() {

    if ( maxLength_$ == null ) {
      maxLength_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(MAX_LENGTH)
        .build();
    }
  ...
  private Object maxLength_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setMaxLength(Object value) {
    ...
    boolean hasOldValue = hasPropertySet("maxLength");
    Object oldValue = hasOldValue ?
      getMaxLength() :
      null;
    Object castedValue = maxLength_adapt(oldValue, value, hasOldValue);
    
    maxLength_isSet_ = true;
    maxLength_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "maxLength", null };
    if ( hasListeners(args) ) {
      args[2] = getMaxLength$();
      pub(args);
    }
  ...
  private static foam.core.Property init_MAX_LENGTH() {
  ...
  public String getSwiftView() {
    ...
    if ( ! swiftView_isSet_ ) {
      return "foam.swift.ui.FOAMUITextField";
    }
    return swiftView_;
  }
  ...
  private static foam.core.StringProperty init_SWIFT_VIEW() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.swift.ui.FOAMUITextField")
      .setName("swiftView")
      .setForClass_("foam.core.Property")
      .build();
  }
  ...
  public String getJavaInfoType() {
    ...
    if ( ! javaInfoType_isSet_ ) {
      return "foam.core.AbstractStringPropertyInfo";
    }
    return javaInfoType_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_INFO_TYPE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.core.AbstractStringPropertyInfo")
  ...
  private static foam.core.StringProperty init_JAVA_JSONPARSER() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("new foam.lib.json.StringParser()")
  ...
  public String getJavaQueryParser() {
    ...
    if ( ! javaQueryParser_isSet_ ) {
      return "new foam.lib.query.StringParser()";
    }
    return javaQueryParser_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_QUERY_PARSER() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("new foam.lib.query.StringParser()")
  ...
  private static foam.core.StringProperty init_JAVA_CSVPARSER() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("new foam.lib.csv.CSVStringParser()")
  ...
  private int displayWidth_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setDisplayWidth(Object value) {
    ...
    Object oldValue = hasOldValue ?
      getDisplayWidth() :
      null;
    int castedValue = displayWidth_adapt(oldValue, value, hasOldValue);
  ...
  private static foam.core.IntProperty init_DISPLAY_WIDTH() {
  ...
  public void clearProperty(String name) {
    ...
    switch(name) {
      ...
      case "trim":
        trim_isSet_ = false;
        Object[] trimArgs = new Object[] { "propertyChange", "trim", null };
        if ( hasListeners(trimArgs) ) {
          trimArgs[2] = getTrim$();
          pub(trimArgs);
        }
        return;
      ...
      case "width":
        width_isSet_ = false;
        Object[] widthArgs = new Object[] { "propertyChange", "width", null };
        if ( hasListeners(widthArgs) ) {
          widthArgs[2] = getWidth$();
          pub(widthArgs);
        }
        return;
      ...
      case "minLength":
        minLength_isSet_ = false;
        Object[] minLengthArgs = new Object[] { "propertyChange", "minLength", null };
        if ( hasListeners(minLengthArgs) ) {
          minLengthArgs[2] = getMinLength$();
          pub(minLengthArgs);
        }
        return;
      ...
      case "maxLength":
        maxLength_isSet_ = false;
        Object[] maxLengthArgs = new Object[] { "propertyChange", "maxLength", null };
        if ( hasListeners(maxLengthArgs) ) {
          maxLengthArgs[2] = getMaxLength$();
          pub(maxLengthArgs);
        }
        return;
  ...
  public boolean hasPropertySet(String name) {
    ...
    switch(name) {
      ...
      case "minLength":
        return minLength_isSet_;
    
    
      case "maxLength":
        return maxLength_isSet_;
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.StringProperty")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.core.StringProperty.TRIM, foam.core.StringProperty.WIDTH, foam.core.StringProperty.MIN_LENGTH, foam.core.StringProperty.MAX_LENGTH, foam.core.StringProperty.SQL_TYPE, foam.core.StringProperty.DISPLAY_WIDTH})
      .build();
  }

  public static Builder StringPropertyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public Builder setTrim(boolean value) {
    ...
    public Builder setMinLength(Object value) {
    ...
    public Builder setMaxLength(Object value) {
    ...
    public Builder setDisplayWidth(int value) {
    ...
    public StringProperty build() {
      ...
      StringProperty o = new StringProperty();
      ...
      if ( minLength_isSet_ ) {
        o.setMinLength(minLength_);
      }
      
      if ( maxLength_isSet_ ) {
        o.setMaxLength(maxLength_);
      }
