...
/**
* A Property which contains an array of 'of' FObjects. 
*/
public class FObjectArray extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  private static foam.core.Property init_OF() {
    ...
    return foam.core.Property.PropertyBuilder(null) // TODO give context
      .setName("of")
      .setRequired(true)
      .setForClass_("foam.core.FObjectArray")
      .build();
  }
  ...
  public String getJavaInfoType() {
    ...
    if ( ! javaInfoType_isSet_ ) {
      return "foam.core.AbstractFObjectArrayPropertyInfo";
    }
    return javaInfoType_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_INFO_TYPE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.core.AbstractFObjectArrayPropertyInfo")
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.FObjectArray")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.core.FObjectArray.OF, foam.core.FObjectArray.ADAPT_ARRAY_ELEMENT, foam.core.FObjectArray.FROM_JSON, foam.templates.TemplateAxiom.TemplateAxiomBuilder(null) // TODO give context
  ...
  public static Builder FObjectArrayBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public FObjectArray build() {

      FObjectArray o = new FObjectArray();
