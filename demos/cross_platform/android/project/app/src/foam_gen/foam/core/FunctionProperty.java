...
/**
* Describes properties of type Function. 
*/
public class FunctionProperty extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  protected foam.cross_platform.NullFunction.Builder NullFunction_create() {

    return foam.cross_platform.NullFunction.NullFunctionBuilder(getSubX());
  }
  ...
  public Object getType() {
    ...
    if ( ! type_isSet_ ) {
      return "foam.cross_platform.GenericFunction";
    }
    return type_;
  }
  ...
  private static foam.core.Property init_TYPE() {
    ...
    return foam.core.Property.PropertyBuilder(null) // TODO give context
      .setName("type")
      .setValue("foam.cross_platform.GenericFunction")
  ...
  private static foam.core.StringProperty init_ANDROID_VALUE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.cross_platform.NullFunction.NullFunctionBuilder(null).build()")
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.FunctionProperty")
      ...
      .setPath("foam.cross_platform.NullFunction")
      .build()})
      .build();
  }

  public static Builder FunctionPropertyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public FunctionProperty build() {
      ...
      FunctionProperty o = new FunctionProperty();
