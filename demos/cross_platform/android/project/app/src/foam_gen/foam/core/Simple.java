...
public class Simple extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      ...
      .setCode(null)
      .setForClass_("foam.core.Simple")
      .setArgs(new foam.core.Argument[] {  })
      .build()})
      .build();
  }

  public static Builder SimpleBuilder(foam.cross_platform.Context x) {
