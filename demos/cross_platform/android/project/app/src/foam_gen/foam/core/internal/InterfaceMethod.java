...
/**
* An InterfaceMethod is a Method declaration, but lacks code. 
*/
public class InterfaceMethod extends foam.core.Method {
  ...
  private static foam.core.BooleanProperty init_ABSTRACT() {
    ...
    return foam.core.BooleanProperty.BooleanPropertyBuilder(null) // TODO give context
      .setValue(true)
      .setName("abstract")
      .setForClass_("foam.core.internal.InterfaceMethod")
      .build();
  }
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.internal.InterfaceMethod")
      .setParent(foam.core.Method.CLS_)
      .setAxioms(new Object[] {foam.core.internal.InterfaceMethod.ABSTRACT, foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("ProtocolMethod")
      .setPath("foam.swift.ProtocolMethod")
      .build()})
      .build();
  }

  public static Builder InterfaceMethodBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public InterfaceMethod build() {
      ...
      InterfaceMethod o = new InterfaceMethod();
