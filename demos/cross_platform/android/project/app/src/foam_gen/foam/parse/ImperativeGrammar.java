...
public class ImperativeGrammar extends foam.parse.Grammar {
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.parse.ImperativeGrammar")
      .setParent(foam.parse.Grammar.CLS_)
      .setAxioms(new Object[] {})
      .build();
  }

  public static Builder ImperativeGrammarBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public ImperativeGrammar build() {

      ImperativeGrammar o = new ImperativeGrammar();
