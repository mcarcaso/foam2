...
/**
*   Set a ViewFactory to be a string containing a class name,  a Class object, or a factory function(args, context).  Useful for rowViews 
* and similar. 
*/
public class ViewSpec extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  public static foam.core.Property VIEW =
    init_VIEW();
  ...
  public Object getView() {
    ...
    {
    put("class", "foam.u2.view.MapView");
    }
    }
    ;
    }
  ...
  private static foam.core.Property init_VIEW() {
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.u2.ViewSpec")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.core.AnonymousAxiom.AnonymousAxiomBuilder(null) // TODO give context
      .setInstallInClass(null)
      .build(), foam.u2.ViewSpec.VIEW, foam.u2.ViewSpec.DISPLAY_WIDTH})
      .build();
  }

  public static Builder ViewSpecBuilder(foam.cross_platform.Context x) {
