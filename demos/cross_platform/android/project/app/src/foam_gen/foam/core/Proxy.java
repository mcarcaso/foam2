...
public class Proxy extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  public static foam.core.StringArrayProperty TOPICS =
    init_TOPICS();

  protected String[] forwards_;

  private boolean forwards_isSet_ =
    false;

  private foam.core.Slot forwards_$;

  public static foam.core.StringArrayProperty FORWARDS =
    init_FORWARDS();

  protected String[] delegates_;

  private boolean delegates_isSet_ =
    false;

  private foam.core.Slot delegates_$;

  public static foam.core.StringArrayProperty DELEGATES =
    init_DELEGATES();
  ...
  protected foam.core.EventProxy.Builder EventProxy_create() {

    return foam.core.EventProxy.EventProxyBuilder(getSubX());
  }

  protected foam.core.ProxiedMethod.Builder ProxiedMethod_create() {

    return foam.core.ProxiedMethod.ProxiedMethodBuilder(getSubX());
  }

  protected foam.core.ProxySub.Builder ProxySub_create() {

    return foam.core.ProxySub.ProxySubBuilder(getSubX());
  }
  ...
  protected String[] topics_factory_() {
  ...
  private String[] topics_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setTopics(Object value) {
    ...
    Object oldValue = hasOldValue ?
      getTopics() :
      null;
    String[] castedValue = topics_adapt(oldValue, value, hasOldValue);
  ...
  private static foam.core.StringArrayProperty init_TOPICS() {

    return foam.core.StringArrayProperty.StringArrayPropertyBuilder(null) // TODO give context
      .setName("topics")
      .setForClass_("foam.core.Proxy")
      .build();
  }

  public foam.core.Slot getForwards$() {

    if ( forwards_$ == null ) {
      forwards_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(FORWARDS)
        .build();
    }
  ...
  protected String[] forwards_factory_() {
  ...
  public String[] getForwards() {
    ...
    if ( ! forwards_isSet_ ) {
      setProperty("forwards", forwards_factory_());
    }
    return forwards_;
  }

  private String[] forwards_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (String[]) newValue;
  }

  public void setForwards(Object value) {

    boolean hasOldValue = hasPropertySet("forwards");
    Object oldValue = hasOldValue ?
      getForwards() :
      null;
    String[] castedValue = forwards_adapt(oldValue, value, hasOldValue);
    
    forwards_isSet_ = true;
    forwards_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "forwards", null };
    if ( hasListeners(args) ) {
      args[2] = getForwards$();
      pub(args);
    }
  ...
  private static foam.core.StringArrayProperty init_FORWARDS() {
  ...
  public foam.core.Slot getDelegates$() {

    if ( delegates_$ == null ) {
      delegates_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(DELEGATES)
        .build();
    }
  ...
  protected String[] delegates_factory_() {
  ...
  public String[] getDelegates() {
    ...
    if ( ! delegates_isSet_ ) {
      setProperty("delegates", delegates_factory_());
    }
    return delegates_;
  }

  private String[] delegates_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (String[]) newValue;
  }

  public void setDelegates(Object value) {

    boolean hasOldValue = hasPropertySet("delegates");
    Object oldValue = hasOldValue ?
      getDelegates() :
      null;
    String[] castedValue = delegates_adapt(oldValue, value, hasOldValue);
    
    delegates_isSet_ = true;
    delegates_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "delegates", null };
    if ( hasListeners(args) ) {
      args[2] = getDelegates$();
      pub(args);
    }
  ...
  private static foam.core.StringArrayProperty init_DELEGATES() {
  ...
  public String getJavaInfoType() {
    ...
    if ( ! javaInfoType_isSet_ ) {
      return "foam.core.AbstractFObjectPropertyInfo";
    }
    return javaInfoType_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_INFO_TYPE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.core.AbstractFObjectPropertyInfo")
  ...
  private static foam.core.StringProperty init_JAVA_JSONPARSER() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("new foam.lib.json.FObjectParser()")
  ...
  public void clearProperty(String name) {
    ...
    switch(name) {
      ...
      case "forwards":
        forwards_isSet_ = false;
        Object[] forwardsArgs = new Object[] { "propertyChange", "forwards", null };
        if ( hasListeners(forwardsArgs) ) {
          forwardsArgs[2] = getForwards$();
          pub(forwardsArgs);
        }
        return;
      ...
      case "delegates":
        delegates_isSet_ = false;
        Object[] delegatesArgs = new Object[] { "propertyChange", "delegates", null };
        if ( hasListeners(delegatesArgs) ) {
          delegatesArgs[2] = getDelegates$();
          pub(delegatesArgs);
        }
        return;
  ...
  public boolean hasPropertySet(String name) {
    ...
    switch(name) {
      ...
      case "forwards":
        return forwards_isSet_;
    
    
      case "delegates":
        return delegates_isSet_;
  ...
  public void setProperty(String name, Object value) {
    ...
    switch(name) {
      ...
      case "forwards":
        setForwards((String[]) value);
        return;
    
    
      case "delegates":
        setDelegates((String[]) value);
        return;
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.Proxy")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("EventProxy")
      .setPath("foam.core.EventProxy")
      .build(), foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("ProxiedMethod")
      .setPath("foam.core.ProxiedMethod")
      .build(), foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("ProxySub")
      .setPath("foam.core.ProxySub")
      .build(), foam.core.Proxy.TOPICS, foam.core.Proxy.FORWARDS, foam.core.Proxy.DELEGATES})
      .build();
  }

  public static Builder ProxyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    private String[] forwards_;

    private boolean delegates_isSet_ =
      false;

    private String[] delegates_;
    ...
    public Builder setForwards(String[] value) {
    ...
    public Builder setDelegates(String[] value) {
    ...
    public Proxy build() {
      ...
      if ( forwards_isSet_ ) {
        o.setForwards(forwards_);
      }
      
      if ( delegates_isSet_ ) {
        o.setDelegates(delegates_);
      }
