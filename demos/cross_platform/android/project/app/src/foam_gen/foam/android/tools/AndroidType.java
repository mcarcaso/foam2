...
public class AndroidType extends foam.core.StringProperty implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  private static foam.core.StringArrayProperty init_FLAGS() {
    ...
    return foam.core.StringArrayProperty.StringArrayPropertyBuilder(null) // TODO give context
      .setValue(new Object[] {"android"})
      .setFactory(null)
      .setName("flags")
      .setForClass_("foam.android.tools.AndroidType")
      .build();
  }
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.android.tools.AndroidType")
      .setParent(foam.core.StringProperty.CLS_)
      .setAxioms(new Object[] {foam.android.tools.AndroidType.FLAGS})
      .build();
  }

  public static Builder AndroidTypeBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public AndroidType build() {

      AndroidType o = new AndroidType();
