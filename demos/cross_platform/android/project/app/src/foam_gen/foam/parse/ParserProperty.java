...
public class ParserProperty extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.parse.ParserProperty")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {})
      .build();
  }

  public static Builder ParserPropertyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public ParserProperty build() {

      ParserProperty o = new ParserProperty();
