...
public class PromiseProperty extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  public String getAndroidType() {
    ...
    if ( ! androidType_isSet_ ) {
      return "foam.cross_platform.Promise";
    }
    return androidType_;
  }
  ...
  private static foam.android.tools.AndroidType init_ANDROID_TYPE() {
    ...
    return foam.android.tools.AndroidType.AndroidTypeBuilder(null) // TODO give context
      .setName("androidType")
      .setValue("foam.cross_platform.Promise")
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.PromiseProperty")
  ...
  public static Builder PromisePropertyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public PromiseProperty build() {

      PromiseProperty o = new PromiseProperty();
