...
*/
public class BooleanProperty extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  private boolean label2_isSet_ =
    false;

  private foam.core.Slot label2_$;

  public static foam.core.StringProperty LABEL2 =
    init_LABEL2();

  protected Object label2Formatter_;

  private boolean label2Formatter_isSet_ =
    false;

  private foam.core.Slot label2Formatter_$;

  public static foam.core.Property LABEL2FORMATTER =
    init_LABEL2FORMATTER();
  ...
  public String getJavaInfoType() {
    ...
    if ( ! javaInfoType_isSet_ ) {
      return "foam.core.AbstractBooleanPropertyInfo";
    }
    return javaInfoType_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_INFO_TYPE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.core.AbstractBooleanPropertyInfo")
  ...
  private static foam.core.StringProperty init_JAVA_JSONPARSER() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("new foam.lib.json.BooleanParser()")
  ...
  private static foam.core.Property init_SQL_TYPE() {
    ...
    return foam.core.Property.PropertyBuilder(null) // TODO give context
      .setName("sqlType")
      .setValue("BOOLEAN")
      .setForClass_("foam.core.BooleanProperty")
      .build();
  }
  ...
  public foam.core.Slot getLabel2$() {

    if ( label2_$ == null ) {
      label2_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(LABEL2)
        .build();
    }
  ...
  private String label2_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (String) newValue;
  }

  public void setLabel2(Object value) {

    boolean hasOldValue = hasPropertySet("label2");
    Object oldValue = hasOldValue ?
      getLabel2() :
      null;
    String castedValue = label2_adapt(oldValue, value, hasOldValue);
    
    label2_isSet_ = true;
    label2_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "label2", null };
    if ( hasListeners(args) ) {
      args[2] = getLabel2$();
      pub(args);
    }
  ...
  private static foam.core.StringProperty init_LABEL2() {
  ...
  public foam.core.Slot getLabel2Formatter$() {

    if ( label2Formatter_$ == null ) {
      label2Formatter_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(LABEL2FORMATTER)
        .build();
    }
    return label2Formatter_$;
  }

  public Object getLabel2Formatter() {

    if ( ! label2Formatter_isSet_ ) {
      return null;
    }
    return label2Formatter_;
  }

  private Object label2Formatter_adapt(Object oldValue, Object newValue, boolean oldValueSet) {

    return (Object) newValue;
  }

  public void setLabel2Formatter(Object value) {

    boolean hasOldValue = hasPropertySet("label2Formatter");
    Object oldValue = hasOldValue ?
      getLabel2Formatter() :
      null;
    Object castedValue = label2Formatter_adapt(oldValue, value, hasOldValue);
    
    label2Formatter_isSet_ = true;
    label2Formatter_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "label2Formatter", null };
    if ( hasListeners(args) ) {
      args[2] = getLabel2Formatter$();
      pub(args);
    }
  }

  private static foam.core.Property init_LABEL2FORMATTER() {

    return foam.core.Property.PropertyBuilder(null) // TODO give context
      .setName("label2Formatter")
      .setForClass_("foam.core.BooleanProperty")
      .build();
  }
  ...
  public Object getSearchView() {
    ...
    new java.util.HashMap<String, Object>() {
    {
    put("class", "foam.u2.search.GroupBySearchView");
    put("viewSpec",
    new java.util.HashMap<String, Object>() {
    {
    put("class", "foam.u2.view.ChoiceView");
    put("size", 3);
    }
    }
    );
  ...
  public void clearProperty(String name) {
    ...
    switch(name) {
      ...
      case "label2":
        label2_isSet_ = false;
        Object[] label2Args = new Object[] { "propertyChange", "label2", null };
        if ( hasListeners(label2Args) ) {
          label2Args[2] = getLabel2$();
          pub(label2Args);
        }
        return;
    
    
      case "label2Formatter":
        label2Formatter_isSet_ = false;
        Object[] label2FormatterArgs = new Object[] { "propertyChange", "label2Formatter", null };
        if ( hasListeners(label2FormatterArgs) ) {
          label2FormatterArgs[2] = getLabel2Formatter$();
          pub(label2FormatterArgs);
        }
        return;
  ...
  public boolean hasPropertySet(String name) {
    ...
    switch(name) {
      ...
      case "label2":
        return label2_isSet_;
    
    
      case "label2Formatter":
        return label2Formatter_isSet_;
  ...
  public void setProperty(String name, Object value) {
    ...
    switch(name) {
      ...
      case "label2":
        setLabel2((String) value);
        return;
    
    
      case "label2Formatter":
        setLabel2Formatter((Object) value);
        return;
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.BooleanProperty")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.core.BooleanProperty.SQL_TYPE, foam.core.BooleanProperty.LABEL2, foam.core.BooleanProperty.LABEL2FORMATTER})
      .build();
  }

  public static Builder BooleanPropertyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    private Object label2Formatter_;
    ...
    public Builder setLabel2(String value) {
    ...
    public Builder setLabel2Formatter(Object value) {

      label2Formatter_isSet_ = true;
      label2Formatter_ = value;
      return this;
    }
    ...
    public BooleanProperty build() {
      ...
      if ( label2Formatter_isSet_ ) {
        o.setLabel2Formatter(label2Formatter_);
      }
