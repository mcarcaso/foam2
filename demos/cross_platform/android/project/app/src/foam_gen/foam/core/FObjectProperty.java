...
public class FObjectProperty extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  public foam.cross_platform.FoamClass getOf() {
    ...
    if ( ! of_isSet_ ) {
      return foam.cross_platform.AbstractFObject.CLS_;
    }
    return of_;
  }
  ...
  private static foam.core.ClassProperty init_OF() {
    ...
    return foam.core.ClassProperty.ClassPropertyBuilder(null) // TODO give context
      .setName("of")
      .setValue("foam.core.FObject")
      .setForClass_("foam.core.FObjectProperty")
      .build();
  }
  ...
  public void xinitObject() {

    throw new RuntimeException("xinitObject is not implemented");
  }

  protected foam.lib.csv.PrefixedCSVOutputter.Builder PrefixedCSVOutputter_create() {

    return foam.lib.csv.PrefixedCSVOutputter.PrefixedCSVOutputterBuilder(getSubX());
  }
  ...
  public foam.u2.view.Formatter getTableCellFormatter() {
    ...
    if ( ! tableCellFormatter_isSet_ ) {
      return foam.u2.view.FnFormatter.FnFormatterBuilder(null) // TODO give context
    .setF(null)
    .build();
    }
    return tableCellFormatter_;
  ...
  private static foam.u2.view.TableCellFormatter init_TABLE_CELL_FORMATTER() {
    ...
    return foam.u2.view.TableCellFormatter.TableCellFormatterBuilder(null) // TODO give context
      .setValue(foam.u2.view.FnFormatter.FnFormatterBuilder(null) // TODO give context
      .setF(null)
      .build())
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.FObjectProperty")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.core.FObjectProperty.OF, foam.core.Method.MethodBuilder(null) // TODO give context
      .setName("xinitObject")
      .setCode(null)
      .setForClass_("foam.core.FObjectProperty")
      .setArgs(new foam.core.Argument[] {  })
      .build(), foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("PrefixedCSVOutputter")
      .setPath("foam.lib.csv.PrefixedCSVOutputter")
      .build(), foam.core.FObjectProperty.AUTO_VALIDATE, foam.core.Method.MethodBuilder(null) // TODO give context
      .setName("getDeps")
      .setCode(null)
      .setForClass_("foam.core.FObjectProperty")
      .setArgs(new foam.core.Argument[] {  })
  ...
  public static Builder FObjectPropertyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public FObjectProperty build() {

      FObjectProperty o = new FObjectProperty();
