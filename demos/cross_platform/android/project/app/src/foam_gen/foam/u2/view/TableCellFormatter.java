...
public class TableCellFormatter extends foam.core.FObjectProperty implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  protected foam.core.FObjectProperty.Builder FObjectProperty_create() {

    return foam.core.FObjectProperty.FObjectPropertyBuilder(getSubX());
  }

  protected foam.u2.view.FnFormatter.Builder FnFormatter_create() {

    return foam.u2.view.FnFormatter.FnFormatterBuilder(getSubX());
  }
  ...
  public foam.cross_platform.FoamClass getOf() {
    ...
    if ( ! of_isSet_ ) {
      return foam.u2.view.Formatter.CLS_;
    }
    return of_;
  }
  ...
  private static foam.core.ClassProperty init_OF() {
    ...
    return foam.core.ClassProperty.ClassPropertyBuilder(null) // TODO give context
      .setName("of")
      .setValue("foam.u2.view.Formatter")
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.u2.view.TableCellFormatter")
      .setParent(foam.core.FObjectProperty.CLS_)
      .setAxioms(new Object[] {foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("FObjectProperty")
      .setPath("foam.core.FObjectProperty")
      .build(), foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("FnFormatter")
      .setPath("foam.u2.view.FnFormatter")
      .build()})
      .build();
  }

  public static Builder TableCellFormatterBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public TableCellFormatter build() {

      TableCellFormatter o = new TableCellFormatter();
