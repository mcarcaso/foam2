...
public class TemplateAxiom extends foam.core.Method {

  private foam.core.Slot swiftSynchronized_$;

  protected String template_;

  private foam.core.Slot template_$;

  public static foam.core.StringProperty TEMPLATE =
    init_TEMPLATE();
  ...
  private boolean template_isSet_ =
    false;
  ...
  protected foam.templates.TemplateUtil.Builder TemplateUtil_create() {

    return foam.templates.TemplateUtil.TemplateUtilBuilder(getSubX());
  }

  public foam.core.Slot getTemplate$() {

    if ( template_$ == null ) {
      template_$ = foam.core.internal.PropertySlot.PropertySlotBuilder(getX())
        .setObj(this)
        .setProp(TEMPLATE)
        .build();
    }
  ...
  private String template_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setTemplate(Object value) {
    ...
    boolean hasOldValue = hasPropertySet("template");
    Object oldValue = hasOldValue ?
      getTemplate() :
      null;
    String castedValue = template_adapt(oldValue, value, hasOldValue);
    
    template_isSet_ = true;
    template_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "template", null };
  ...
  private static foam.core.StringProperty init_TEMPLATE() {

    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setName("template")
      .setForClass_("foam.templates.TemplateAxiom")
      .build();
  }
  ...
  public void clearProperty(String name) {
    ...
    switch(name) {
      ...
      case "template":
        template_isSet_ = false;
        Object[] templateArgs = new Object[] { "propertyChange", "template", null };
        if ( hasListeners(templateArgs) ) {
          templateArgs[2] = getTemplate$();
          pub(templateArgs);
        }
        return;
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.templates.TemplateAxiom")
      .setParent(foam.core.Method.CLS_)
      .setAxioms(new Object[] {foam.core.Requires.RequiresBuilder(null) // TODO give context
      .setName("TemplateUtil")
      .setPath("foam.templates.TemplateUtil")
      .build(), foam.templates.TemplateAxiom.TEMPLATE})
      .build();
  }

  public static Builder TemplateAxiomBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public TemplateAxiom build() {

      TemplateAxiom o = new TemplateAxiom();
      
      if ( template_isSet_ ) {
        o.setTemplate(template_);
      }
