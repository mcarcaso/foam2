...
public class ProxySub extends foam.core.Method {
  ...
  public static foam.core.StringProperty PROP =
    init_PROP();
  ...
  private String prop_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setProp(Object value) {
    ...
    boolean hasOldValue = hasPropertySet("prop");
    Object oldValue = hasOldValue ?
      getProp() :
      null;
    String castedValue = prop_adapt(oldValue, value, hasOldValue);
    
    prop_isSet_ = true;
    prop_ = castedValue;
    Object[] args = new Object[] { "propertyChange", "prop", null };
    if ( hasListeners(args) ) {
      args[2] = getProp$();
      pub(args);
    }
  ...
  private static foam.core.StringProperty init_PROP() {

    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setName("prop")
      .setForClass_("foam.core.ProxySub")
      .build();
  }
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.ProxySub")
      .setParent(foam.core.Method.CLS_)
      .setAxioms(new Object[] {foam.core.ProxySub.PROP, foam.core.ProxySub.TOPICS})
      .build();
  }

  public static Builder ProxySubBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public Builder setProp(String value) {
    ...
    public ProxySub build() {

      ProxySub o = new ProxySub();
