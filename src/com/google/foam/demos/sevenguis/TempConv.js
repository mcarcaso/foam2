...
foam.CLASS({
  ...
  properties: [
    [ 'nodeName', 'span' ],
    { class: 'FloatProperty', name: 'c', view: { class: 'foam.u2.FloatView', onKey: true, precision: 4 } },
    { class: 'FloatProperty', name: 'f', view: { class: 'foam.u2.FloatView', onKey: true, precision: 4 } }
  ],
