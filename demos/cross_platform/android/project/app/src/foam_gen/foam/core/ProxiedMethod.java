...
public class ProxiedMethod extends foam.core.Method {
  ...
  public static foam.core.BooleanProperty DELEGATE =
    init_DELEGATE();
  ...
  private static foam.core.StringProperty init_PROPERTY() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setName("property")
      .setForClass_("foam.core.ProxiedMethod")
      .build();
  }
  ...
  private boolean delegate_adapt(Object oldValue, Object newValue, boolean oldValueSet) {
  ...
  public void setDelegate(Object value) {
    ...
    Object oldValue = hasOldValue ?
      getDelegate() :
      null;
    boolean castedValue = delegate_adapt(oldValue, value, hasOldValue);
  ...
  private static foam.core.BooleanProperty init_DELEGATE() {
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.ProxiedMethod")
      .setParent(foam.core.Method.CLS_)
      .setAxioms(new Object[] {foam.core.ProxiedMethod.PROPERTY, foam.core.ProxiedMethod.DELEGATE})
      .build();
  }

  public static Builder ProxiedMethodBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public Builder setDelegate(boolean value) {
    ...
    public ProxiedMethod build() {

      ProxiedMethod o = new ProxiedMethod();
