...
*/
public class StringArrayProperty extends foam.core.Property implements foam.mlang.order.Comparator, foam.dao.SQLStatement {
  ...
  private static foam.core.Property init_OF() {
    ...
    return foam.core.Property.PropertyBuilder(null) // TODO give context
      .setName("of")
      .setDocumentation("The FOAM sub-type of this property.")
      .setValue("String")
  ...
  public String getJavaInfoType() {
    ...
    if ( ! javaInfoType_isSet_ ) {
      return "foam.core.AbstractArrayPropertyInfo";
    }
    return javaInfoType_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_INFO_TYPE() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("foam.core.AbstractArrayPropertyInfo")
  ...
  public String getJavaJSONParser() {
    ...
    if ( ! javaJSONParser_isSet_ ) {
      return "new foam.lib.json.StringArrayParser()";
    }
    return javaJSONParser_;
  }
  ...
  private static foam.core.StringProperty init_JAVA_JSONPARSER() {
    ...
    return foam.core.StringProperty.StringPropertyBuilder(null) // TODO give context
      .setValue("new foam.lib.json.StringArrayParser()")
  ...
  private static foam.core.Property init_SQL_TYPE() {
    ...
    return foam.core.Property.PropertyBuilder(null) // TODO give context
      .setName("sqlType")
      .setValue("TEXT")
      .setForClass_("foam.core.StringArrayProperty")
      .build();
  }
  ...
  public void compareTemplate() {
    ...
    throw new RuntimeException("compareTemplate is not implemented");
  }
  ...
  public static foam.cross_platform.FoamClass initClassInfo_() {
    ...
    return foam.cross_platform.FoamClass.FoamClassBuilder(null) // TODO give context
      .setId("foam.core.StringArrayProperty")
      .setParent(foam.core.Property.CLS_)
      .setAxioms(new Object[] {foam.core.StringArrayProperty.SQL_TYPE, foam.templates.TemplateAxiom.TemplateAxiomBuilder(null) // TODO give context
      .setTemplate(" <%= this.javaType %> values1 = get_(o1);\n<%= this.javaType %> values2 = get_(o2);\nif ( values1 == null && values2 == null ) return 0;\nif ( values2 == null ) return 1;\nif ( values1 == null ) return -1;\n\nif ( values1.length > values2.length ) return 1;\nif ( values1.length < values2.length ) return -1;\n\nint result;\nfor ( int i = 0 ; i < values1.length ; i++ ) {\n  result = foam.util.SafetyUtil.compare(values1[i], values2[i]);\n  if ( result != 0 ) return result;\n}\nreturn 0;")
      .setArgs(new foam.core.Argument[] {  })
      .setName("compareTemplate")
      .setForClass_("foam.core.StringArrayProperty")
      .build()})
      .build();
  }

  public static Builder StringArrayPropertyBuilder(foam.cross_platform.Context x) {
  ...
  public static class Builder {
    ...
    public StringArrayProperty build() {

      StringArrayProperty o = new StringArrayProperty();
